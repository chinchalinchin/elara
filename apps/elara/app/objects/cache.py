...
class Cache:
    ...
    _prop_base                      = properties.CacheProps.MODELS_BASE.value
    _prop_tuning                    = properties.CacheProps.MODELS_TUNING.value
    _prop_tuned                     = properties.CacheProps.MODELS_TUNED.value
