...
.. NOTE: 
    The following document is transpiled by Sphinx using the following LaTeX preamble in the ``conf.py``
...
.. TODO: 
    Should probably define speed as the *reciprocal* of this, so increasing the number of stresses "slows" the poem down. Will need to update the Keats decomposition before going further!
