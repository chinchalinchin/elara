...
Let :math:`l(α)` be the character length of a word :math:`α`. 
...
A linguistically true statement that cannot be formally proven: 

.. math::

    \forall R, M_{-+} \subset L: \mid R \mid \leq \mid M_{-+} \mid
