...
.. image:: ../../.static/img/mathematical/probability/function.png
...
The concept of a *function* underwent a radical change in the early 20 :sup:`th` century as set theory was developed by people with names like `Guiseppe Peano <https:/.static/en.wikipedia.org/wiki/Giuseppe_Peano>`_ and `Ernst Zermelo <https:/.static/en.wikipedia.org/wiki/Ernst_Zermelo>`_ to formalize the foundation of mathematics and make it so rigorous it was beyond reproach. To see why the notion of a function had to be extended, consider the following propositions,
...
.. image:: ../../.static/img/mathematical/probability/random_variable.png
    :align: center
...
.. image:: ../../.static/img/mathematical/probability/random_variable_events.png
    :align: center
