...
.. plot:: .scripts/py/plots/examples/04_ex01_die_roll.py
...
.. plot:: .scripts/py/plots/distributions/normal/normal_distribution_cdf.py
...
.. plot:: .scripts/py/plots/distributions/normal/normal_distribution_inverse.py
...
.. image:: ../../../.static/img/mathematical/statistics/tables/table-positive-z.png
	:align: center
...
.. plot:: .scripts/py/plots/distributions/normal/normal_distribution_parameters.py
...
.. plot:: .scripts/py/plots/other/qq_plot_simple.py
...
The :ref:`normal-distribution` is deeply connected with many different areas of mathematics. It pops up everywhere, from `quantum mechanics <https:/.static/en.wikipedia.org/wiki/Wave_packet>`_ to `finance <https:/.static/www.investopedia.com/articles/investing/102014/lognormal-and-normal-distribution.asp#:~:text=When%20the%20investor%20continuously%20compounds,time%20in%20a%20normal%20distribution.>`_. The reach of the *normal distribution* is far and wide.
