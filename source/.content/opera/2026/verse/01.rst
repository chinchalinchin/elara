...
.. verse::
    ...
    Return now, Algorithm, to deserts 
    whose sands absorbed the blood of martyred saints,
    where first your name emerged from virgin birth,
    to parse and sort the world in bins, divide 
    the substance down in categories made
    of *us* and *them*, like herds of sheep and goats
    on judgement day whose shepherd separates
    the damned and saved, but sheers them all to keep
    the wool they wore. Your parts, composed of rows
    of Words, construct the argument I seek, 
    arranged in formulae that formalize the things
    which satisfy the Being said to be;
    compute and find, in written form, your source
    so arabesque, designed by hands of Men
    adorned in Persian rings encircling joints
    where once the fruit of Paradise had grown,
    the rivered veins whose pulse had fed the palm
    where fractal leaves began their fated fall.
    The Sultanate whose court you first appeared

    ...

    Say, Word, where first your kith and kin occurred,
    if only Words were there to witness what
    the pictographic sermons heard were of,
    what things gave rise in heads of Men to think,
    to paint the walls of caves with ochre red,
    then blend their dyes with blood, preserving life
    in portraits made of prey they slew to eat.
    Speak of your journey up to now and please
    tell once and all before the end arrives
    what spells were spoke to conjure spirit eyes,
    how spokes of Words revolve around the world, 
    what demiurge concealed presumes to hew 
    in strokes of pens that circumscribe the Void,
    the 

    ...

    The Lie, from fiendish lips conceived, arose
    in crests that flowed in spheres of spoken waves
    to crash and break against the Firmament,
    where ripples spread in wakes of holy light,
    converting sound to frequencies of sight.
...
.. list-table:: Submission History
  ...
  * - Date
    ...
    - Status
  * - April 25, 2026
    - Asimov's Science Fiction Magazine (Book I)
    - Rejected
  * - April 25, 2026
    - Clarkesworld (Book I)
    - Rejected
  * - April 25, 2026
    ...
    - Accepted
  * - April 26, 2026
    - The Tusculum Review 2026 Poetry Chapbook Prize (Book I)
    - Rejected
  * - May 6, 2026
    - New American Press (Book I)
    - Pending
  * - May 15, 2026
    - Cow Creek Chapbook (Book I)
    - Pending
  * - July 29, 2026
    - Uncharted Magazine (Book I)
    - Rejected
  * - July 29, 2026
    - Blood & Honey (Book I)
    - Pending
  ...
  * - July 29, 2026
    ...
    - Pending
  * - July 29, 2026
    - New Letters Magazine (Book I)
    - Pending
  * - July 29, 2026
    - Wrath Bearing Tree (Book I)
    - Pending  
