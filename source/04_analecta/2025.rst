...
A :ref:`perfect palindrome <palindromics-definition-2-3-2>` is symmetric, by which it is meant a :ref:`perfect palindrome <palindromics-definition-2-3-2>` may be reversed character-wise. Of the "species" of :ref:`palindromes <palindromics-definition-2-3-1>` in any given :ref:`language <language>`, they are the most rare, because their grammatical conditions are so stringent (at least as far as English is concerned). Counter-intuitively, this makes them the easiest to construct.

:ref:`Perfect palindromes <palindromics-definition-2-3-2>` mostly hinge on :ref:`invertible <palindromics-definition-1-3-2>` grammatical structures embodied in the "*on-no*", "*now-won*" and "*saw-was*" invertible pairs. Without these invertible pivot points, a :ref:`perfect palindromes <palindromics-definition-2-3-2>` must rely on the symmetry of a central :ref:`palindromic word <palindromics-definition-1-3-1>`. In other words, the cardinality of :ref:`perfect palindromes <palindromics-definition-2-3-2>` is related to the cardinality of :ref:`invertible words <palindromics-definition-1-3-2>` and the cardinality of purely :ref:`reflective words <palindromics-definition-1-3-1>`.
