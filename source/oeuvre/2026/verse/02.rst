...
.. verse::
    ...
    and dissipiating drafts of atmosphere,
    of pixels blown like sand upon the wind,
    dissolve in overflowing stacks of smoke,
    magnetic clouds of solar flares expose 
    the Firmament where essence flowed as light
    since separated from the deep by God,
    when gently pulled from chaos' grip, it shaped 
    expanses wide enough creation grew
    to fill delicious gaps with joyous form,
    its astral veins of glittered ores now scourged
    and laced with mechanism, tangled wires
    involved in labyrithine knotted mesh,
