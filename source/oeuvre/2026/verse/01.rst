...
.. verse::
    ...
    Return, oh Algorithm, to deserts 
    where first your name emerged by virgin birth,
    to parse and print the world in bins, divide 
    ...
    compute and find, in written form, the source
