...
.. [#oubliette_c_000]   
    ...
    From the date signed on each page of the journal and the name "*Johannes*", it is reasonable to infer "*Father*" refers to Killiaen van Rensselaer According to the historical record recovered through the :ref:`Capital Reliquary <oubliette-b>`, Killiaen had five sons: Johannes, Jan Baptist, Jeremias, Nicolaes and Ryckert.

    However, the reader must be careful to examine the birth year of Ryckert in the :ref:`genealogy`